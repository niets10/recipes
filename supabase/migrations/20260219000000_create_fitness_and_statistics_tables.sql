...
CREATE POLICY "Users can view own gym_exercises" ON gym_exercises FOR SELECT TO authenticated USING (auth.uid() = user_id);
CREATE POLICY "Users can create own gym_exercises" ON gym_exercises FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can update own gym_exercises" ON gym_exercises FOR UPDATE TO authenticated USING (auth.uid() = user_id) WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can delete own gym_exercises" ON gym_exercises FOR DELETE TO authenticated USING (auth.uid() = user_id);
...
CREATE POLICY "Users can create own activities" ON activities FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
...
CREATE POLICY "Users can view own routines" ON routines FOR SELECT TO authenticated USING (auth.uid() = user_id);
CREATE POLICY "Users can create own routines" ON routines FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can update own routines" ON routines FOR UPDATE TO authenticated USING (auth.uid() = user_id) WITH CHECK (auth.uid() = user_id);
...
CREATE POLICY "Users can view own daily_statistics" ON daily_statistics FOR SELECT TO authenticated USING (auth.uid() = user_id);
CREATE POLICY "Users can create own daily_statistics" ON daily_statistics FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can update own daily_statistics" ON daily_statistics FOR UPDATE TO authenticated USING (auth.uid() = user_id) WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can delete own daily_statistics" ON daily_statistics FOR DELETE TO authenticated USING (auth.uid() = user_id);
...
CREATE POLICY "Users can view daily_routine_entries for own daily_statistics"
  ...
  USING (EXISTS (SELECT 1 FROM daily_statistics ds WHERE ds.id = daily_statistic_id AND ds.user_id = auth.uid()));
CREATE POLICY "Users can insert daily_routine_entries for own daily_statistics"
  ...
  WITH CHECK (EXISTS (SELECT 1 FROM daily_statistics ds WHERE ds.id = daily_statistic_id AND ds.user_id = auth.uid()));
...
CREATE POLICY "Users can view daily_routine_entry_exercises for own entries"
  ...
  USING (EXISTS (
    ...
    WHERE dre.id = daily_routine_entry_id AND ds.user_id = auth.uid()
  ));
