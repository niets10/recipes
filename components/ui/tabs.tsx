...
function TabsList({
    ...
    return (
        <TabsPrimitive.List
            data-slot="tabs-list"
            className={cn(
                'inline-flex h-9 w-fit items-center justify-center gap-2 rounded-lg bg-muted p-1 text-muted-foreground',
                className
            )}
            {...props}
        />
